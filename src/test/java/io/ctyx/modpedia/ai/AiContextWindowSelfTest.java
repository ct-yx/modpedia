...
public final class AiContextWindowSelfTest {
    ...
    public static void main(String[] args) {
        ...
        check(AiAssistantSession.memoryTokenBudget(16_000) >= 16_000
                        && AiAssistantSession.memoryTokenBudget(16_000) < 20_000,
                "16,000 字符搜索预算应保留大部分中文证据，并为消息结构预留余量");
        check(AiAssistantSession.memoryTokenBudget(64_000) <= 48_000,
                "64,000 字符上限仍需有界，避免请求上下文无谓膨胀");
